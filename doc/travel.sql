...
CREATE TABLE `oms_order`  (
  ...
  `bill_header` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '发票抬头',
  `bill_content` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '发票内容',
  `bill_receiver_phone` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收票人电话',
  `bill_receiver_email` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '收票人邮箱',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 77 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oms_order_item`  (
  ...
  `product_attr` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '商品销售属性:[{\"key\":\"颜色\",\"value\":\"颜色\"},{\"key\":\"容量\",\"value\":\"4G\"}]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 115 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单中所包含的商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oms_order_operate_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '订单操作历史记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_brand`  (
  ...
  `show_status` int(0) NULL DEFAULT NULL COMMENT '是否显示：0-不显示；1-显示',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '品牌表' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_brand` VALUES (4, '格力', 'G', 30, 1, 1, 100, 100, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg (3).jpg', NULL, 'Victorias Secret的故事');
INSERT INTO `pms_brand` VALUES (5, '方太', 'F', 20, 1, 1, 100, 100, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg (4).jpg', NULL, 'Victorias Secret的故事');
...
INSERT INTO `pms_brand` VALUES (58, 'NIKE', 'N', 0, 1, 0, 33, 100, 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180615/timg (51).jpg', 'http://localhost:8081/images/6d5db34a-a622-40a5-8528-670b274aa96a.jpg', 'NIKE的故事');
...
CREATE TABLE `pms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 426 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品会员价格表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '商品属性参数表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '产品属性分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 517 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '存储产品参数信息的表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '产品分类' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 148 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '产品满减表(只针对同商品)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 148 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '产品阶梯价格表(只针对同商品)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_sku_stock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 243 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = 'sku的库存' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_admin
-- ----------------------------
INSERT INTO `ums_admin` VALUES (1, 'test', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'https://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/icon/github_icon_02.png', 'test@qq.com', 'test', NULL, '2018-09-29 13:55:30', '2018-09-29 13:55:39', 1);
...
INSERT INTO `ums_admin` VALUES (8, 'test123', '$2a$10$M1qJguEzwoAN0la7PB8UO.HOGe1xZGku7xw1iTaUUpY0ZVRCxrxoO', 'string', 'abc@qq.com', 'string', 'string', '2022-08-07 14:45:42', NULL, 0);
INSERT INTO `ums_admin` VALUES (9, 'test256', '$2a$10$kTMBrt8mkXcO8T4eHThFWOf3KuNK6tqevkiAf4YbtXtaCJ6ocYkJa', 'http://localhost:8081/images/43998541-a4dc-4941-9149-f6660b0172f9.jpg', 'abc@qq.com', 'string', 'string', '2022-08-07 14:52:57', NULL, 1);
...
INSERT INTO `ums_admin` VALUES (11, 'super', '$2a$10$Dj72bwbNVwbwCaBGF3ep9.Z0wXqz1.QXq.2WlyRaXmnzOgzGm9Lue', 'http://localhost:8081/images/2f6cd8be-9c54-413b-abc1-a62440257d5a.png', 'super@111.com', 'super', '我是super超级管理员，我最大', '2023-06-14 14:33:18', '2023-06-16 13:53:04', 1);
INSERT INTO `ums_admin` VALUES (12, 'super1', '$2a$10$Dj72bwbNVwbwCaBGF3ep9.Z0wXqz1.QXq.2WlyRaXmnzOgzGm9Lue', NULL, NULL, NULL, '我有商品和用户的权限', '2023-06-15 09:52:47', '2023-06-16 13:39:08', 1);
INSERT INTO `ums_admin` VALUES (13, 'test1', '$2a$10$UbhF2a9GFodarQFQ2rz4Meu7tKpUCjrz8DY4UiyemPdFUSZOFe26S', NULL, 'test1@111.com', 'test1', '我是一个测试用户', '2023-06-15 14:07:47', NULL, 1);
INSERT INTO `ums_admin` VALUES (14, 'test2', '$2a$10$H87gNi65wYf5JYqOsziGd.DP8PypZfoJLwYptZd8lVswbf1zMD2aW', NULL, 'test1@111.com', 'test1', '我是一个测试用户', NULL, NULL, 1);
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 419 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_admin_login_log` VALUES (413, 11, '2023-06-16 13:29:25', '172.16.11.189', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (414, 12, '2023-06-16 13:39:08', '172.16.11.189', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (415, 11, '2023-06-16 13:39:11', '172.16.11.189', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (416, 11, '2023-06-16 13:42:12', '172.16.11.189', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (417, 11, '2023-06-16 13:50:03', '172.16.11.189', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (418, 11, '2023-06-16 13:53:04', '172.16.11.189', NULL, NULL);
...
CREATE TABLE `ums_admin_permission_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户和权限关系表(除角色中定义的权限以外的加减权限)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin_role_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户和角色关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_admin_role_relation` VALUES (35, 12, 1);
INSERT INTO `ums_admin_role_relation` VALUES (36, 12, 6);
INSERT INTO `ums_admin_role_relation` VALUES (45, 1, 1);
INSERT INTO `ums_admin_role_relation` VALUES (46, 1, 2);
INSERT INTO `ums_admin_role_relation` VALUES (47, 11, 1);
INSERT INTO `ums_admin_role_relation` VALUES (48, 11, 5);
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '会员收货地址表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台菜单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_permission`  (
  ...
  `sort` int(0) NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_permission` VALUES (15, 6, '保存品牌', 'pms:brand:save', NULL, 2, '/pms/brand/save', 1, '2018-09-29 16:49:34', 0);
...
INSERT INTO `ums_permission` VALUES (19, 0, '用户', '', NULL, 0, NULL, 1, '2023-06-14 15:50:27', 0);
INSERT INTO `ums_permission` VALUES (20, 19, '用户列表', 'ums:admin:read', NULL, 1, '/ums/admin/index', 1, '2023-06-14 15:51:11', 0);
INSERT INTO `ums_permission` VALUES (21, 19, '保存用户', 'ums:admin:save', NULL, 1, '/ums/admin/save', 1, '2023-06-15 14:06:03', 0);
INSERT INTO `ums_permission` VALUES (22, 19, '删除用户', 'ums:admin:delete', NULL, 1, '/ums/admin/delete', 1, '2023-06-15 14:13:28', 0);
INSERT INTO `ums_permission` VALUES (23, 19, '分配角色', 'ums:admin:assignRole', NULL, 1, NULL, 1, '2023-06-15 14:52:43', 0);
...
CREATE TABLE `ums_role`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户角色表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_role` VALUES (6, '用户管理员', '只能查看及操作用户', 0, '2023-06-14 15:52:12', 1, 0);
...
CREATE TABLE `ums_role_menu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 127 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台角色菜单关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_role_permission_relation`  (
  ...
  `permission_id` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户角色和权限关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_role_permission_relation` VALUES (19, 6, 20);
INSERT INTO `ums_role_permission_relation` VALUES (20, 5, 20);
INSERT INTO `ums_role_permission_relation` VALUES (21, 5, 21);
INSERT INTO `ums_role_permission_relation` VALUES (22, 5, 22);
INSERT INTO `ums_role_permission_relation` VALUES (23, 6, 21);
INSERT INTO `ums_role_permission_relation` VALUES (24, 6, 22);
INSERT INTO `ums_role_permission_relation` VALUES (25, 6, 23);
INSERT INTO `ums_role_permission_relation` VALUES (26, 5, 23);
INSERT INTO `ums_role_permission_relation` VALUES (27, 5, 6);
INSERT INTO `ums_role_permission_relation` VALUES (28, 6, 6);
INSERT INTO `ums_role_permission_relation` VALUES (29, 5, 15);
INSERT INTO `ums_role_permission_relation` VALUES (30, 5, 17);
